...
export const daysForLocale = (locale: string | string[], startDay: number) => {
...
export const CalendarBody = ({ features, children }: CalendarBodyProps) => {
  ...
  return (
    <ScrollArea className="max-w-[420px] lg:max-w-full w-full overflow-auto border">
    <div className="grid min-w-[400px] grid-cols-7">
      {days.map((day, index) => (
        <div
          key={index}
          className={cn(
